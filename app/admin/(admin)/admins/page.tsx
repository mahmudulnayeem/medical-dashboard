    ...
    return (
        <div className=' px-4'>
            <div className='my-4 px-6 flex items-end justify-between py-6'>
                ...
                <h2 className='text-mix-4 text-3xl font-bold'>List OF Admin</h2>
                <button title='Be Careful Who You Make Admin' className='btn btn-sm btn-mix flex justify-center items-center'> <BsPersonFillAdd /> Add Admin</button>
            </div>
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm opacity-50">16 Floor admin</div>
                                    </div>
                                </div>
                            </td>
                            <td>
