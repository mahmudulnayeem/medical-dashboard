    ...
    return (
        <div className=' px-4'>
            <div className='my-4 px-6 flex items-end justify-between py-6'>
                ...
                <h2 className='text-mix-4 text-3xl font-bold'>List OF Previous Test</h2>
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm opacity-50">Cancer Patient</div>
                                    </div>
                                </div>
                            </td>
                            <td className='text-xl font-medium text-red-300'>Blood Test</td>
                            <td>
