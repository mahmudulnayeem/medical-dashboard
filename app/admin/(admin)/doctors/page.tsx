    ...
    return (
        <div className=' px-4'>
            <div className='my-4 px-6 flex items-end justify-between py-6'>
                ...
                <button className='btn btn-sm btn-mix flex justify-center items-center'> <BsPersonFillAdd /> Add Doctors</button>
            </div>
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm opacity-50">Neurology Expertise</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div className="font-bold">Yoona Kau Han</div>
                                        <div className="text-sm opacity-50">Actress</div>
                                    </div>
                                </div>
                            </td>
                            <td>
